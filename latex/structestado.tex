...
\index{estado@{estado}!bola\+Fogo@{bola\+Fogo}}
\index{bola\+Fogo@{bola\+Fogo}!estado@{estado}}
...
Indicador da utilização do Power Up \char`\"{}\+Bola de Fogo\char`\"{} \index{estado@{estado}!door@{door}}
...
A posição da porta \index{estado@{estado}!flash@{flash}}
\index{flash@{flash}!estado@{estado}}
...
Indicador da ultilização do Power Up "Flash \index{estado@{estado}!inimigo@{inimigo}}
...
Item dropado pelo tesouro \index{estado@{estado}!jog@{jog}}
...
A posição do jogador \index{estado@{estado}!nivel@{nivel}}
...
Nivel de jogo \index{estado@{estado}!no\+Mana@{no\+Mana}}
\index{no\+Mana@{no\+Mana}!estado@{estado}}
...
Indicativo que o jogador se encontra sem mana \index{estado@{estado}!num\+\_\+inimigos@{num\+\_\+inimigos}}
...
Pontuação do jogador \index{estado@{estado}!screen@{screen}}
\index{screen@{screen}!estado@{estado}}
...
Momento em que o jogo se encontra \index{estado@{estado}!treasure@{treasure}}
...
Tesouro que contém um item \index{estado@{estado}!vidas@{vidas}}
